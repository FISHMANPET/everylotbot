...
def main():
    ...
    parser.add_argument('screen_name', metavar='SCREEN_NAME', type=str, help='Twitter screen name (without @)', nargs='?', const=1, default='Every_MTStop')
    parser.add_argument('database', metavar='DATABASE', type=str, help='path to SQLite lots database', nargs='?', const=1, default='stops.db')
